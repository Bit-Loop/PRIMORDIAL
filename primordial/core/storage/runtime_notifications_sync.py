    ...
    def insert_notification(self, notification: NotificationRecord) -> None:
        self._execute(
            ...
            (
                ...
                _storage_text(notification.summary),
    ...
    def insert_external_sync_job(self, job: ExternalSyncJob) -> None:
        self._execute(
            ...
            (
                ...
                job.kind.value,
                job.target_id,
                _storage_text(job.summary),
                _dump(job.payload),
                job.status.value,
                _dump(job.metadata),
                _storage_text(job.last_error) if job.last_error is not None else None,
    ...
    def insert_notion_page(self, page: NotionPage) -> None:
        self._execute(
            ...
            (
                ...
                page.target_id,
                page.page_type,
                _storage_text(page.title),
                page.external_id,
                page.status,
                _storage_text(page.url),
                _dump(page.metadata),
    ...
    def insert_discord_delivery(self, delivery: DiscordDelivery) -> None:
        self._execute(
            ...
            (
                ...
                delivery.attempts,
                _storage_text(delivery.last_error) if delivery.last_error is not None else None,
