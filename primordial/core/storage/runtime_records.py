    ...
    def insert_evidence(self, evidence: EvidenceRecord) -> None:
        self._execute(
            ...
            (
                ...
                evidence.task_id,
                evidence.type.value,
                _storage_text(evidence.title),
                _storage_text(evidence.summary),
                _storage_text(evidence.source_ref),
    ...
    def insert_note(self, note: Note) -> None:
        self._execute(
            ...
            (
                ...
                note.target_id,
                note.task_id,
                _storage_text(note.title),
                _storage_text(note.body),
                note.confidence,
                note.freshness,
                _dump(note.metadata),
    ...
    def insert_interest(self, interest: Interest) -> None:
        self._execute(
            ...
            (
                interest.id,
                interest.target_id,
                _storage_text(interest.title),
                _storage_text(interest.summary),
    ...
    def insert_finding(self, finding: Finding) -> None:
        self._execute(
            ...
            (
                finding.id,
                finding.target_id,
                _storage_text(finding.title),
                _storage_text(finding.summary),
    ...
    def insert_memory_entry(self, entry: MemoryEntry) -> None:
        self._execute(
            ...
            (
                ...
                entry.target_id,
                entry.layer.value,
                _storage_text(entry.title),
                _storage_text(entry.summary),
