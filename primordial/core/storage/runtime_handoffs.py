    ...
    def insert_handoff(self, handoff: TaskHandoff) -> None:
        self._execute(
            ...
            (
                ...
                _storage_text(handoff.reason),
                handoff.expected_output_type,
                _dump(handoff.evidence_refs),
                _storage_text(handoff.hypothesis) if handoff.hypothesis is not None else None,
                _storage_text(handoff.budget) if handoff.budget is not None else None,
