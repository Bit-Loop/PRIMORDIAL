...
function Globe3D({ pins = [], traces = [], onClickPin, selectedId, framework = 'geop' }) {
  ...
  useEffectM(() => {
    ...
    function draw() {
      ...
      // ── LANDMASSES — bright enough to read clearly ──
      if (geoRef.current.loaded) {
        drawRings(geoRef.current.worldRings, R, cx, cy, '#1c3d22', 'rgba(80,200,120,0.28)', 0.65, null);
        drawRings(geoRef.current.stateRings, R, cx, cy, null, 'rgba(80,200,120,0.14)', 0.45, [2, 4]);
      }
